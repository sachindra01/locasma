...
import 'package:locasma/widgets/selected_location_tile.dart';
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: FittedBox(
                                                        child: Padding(padding: const EdgeInsets.all(4.0),
                                                          child: Text(_con.addedMarkersAll.length.toString(), style:white12Height,),
                                                        ),
                                                      ),
                                                    ),
                                                  ),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  shrinkWrap: true,
                  itemCount :_con.addedMarkersAll.length,
                  itemBuilder: (context, index) {
                  return  SelectedLocationTile(
                    locationLogo: _con.addedMarkersAll[index]['iconLogo'],
                    locationName: _con.addedMarkersAll[index]['snippet'],
                    onTap: (){
                      setState(() {
                      _con.addedMarkersAll.removeAt(index);
                      _con.joinStops.removeAt(index);
                      });
                    },
                  );
                  }, 
            ...
            child: Align(
              ...
              child: CustomButton(
                ...
                onPress: () {
                  setState(() {
                  _con.joinStopsNoLast.clear();
                  _con.joinStopsNoLast.addAll(_con.joinStops);
                  });
                  _con.addedMarkersAll.isEmpty ?
                    fToast.showToast(
                      child: Stack(
                        children: [
                          Padding(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              alignment: Alignment.center,
                              child: Text(
                                "Select more than one locations",
                                style: darkBlue16,
                              ),
                            ),
                          ),
      ...
      markers.add(
        MapMarker(
          ...
          infoWindow: InfoWindow(
            ...
            onTap: (){
              setState(() {
                _con.addedMarkersAll.add({
                  "snippet": _con.markersList[i]["snippet"],
                  "iconLogo": _con.markersList[i]["markerIcon"]
                });
                //add markers to list
                addedMarkers.addAll({
